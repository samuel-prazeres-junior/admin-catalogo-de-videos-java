...
public class ListCategoriesUseCaseIT {
    ...
    public void givenAValidTerm_whenTermDoesntMatchsPrePersisted_shoudReturnEmptyPage() {
        ...
        final var expectedTerms = "dspsjkfsds";
    ...
    @ParameterizedTest
    @CsvSource({
            "fil,0,10,1,1,Filmes", // passando parametros para o teste (term,page,perPage,itemsCount,total,categoria esperada)
    ...
    public void givenAValidTerm_whenCallsListCategories_shoudReturnCategoriesFiltered(
