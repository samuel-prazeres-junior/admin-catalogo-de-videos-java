...
public class GenreAPITest {
    ...
    public void givenAValidId_whenCallsGetGenreById_shouldReturnGenre() throws Exception {
        ...
        verify(getGenreByIdUseCase).execute(eq(expectedId));// por default o times do verify ja é 1, então não precisa colocar
    }
    ...
    public void givenAnInvalidId_whenCallsGetGenreById_shouldReturnNotFound() throws Exception {
        ...
        verify(getGenreByIdUseCase).execute(eq(expectedId.getValue())) ;// por default o times do verify ja é 1, então não precisa colocar
    }
    ...
    @Test
    public void givenAValid_whenCallsDeleteGenre_shouldReturnBeOk() throws Exception {
        // given
        final var expectedId = "123";
