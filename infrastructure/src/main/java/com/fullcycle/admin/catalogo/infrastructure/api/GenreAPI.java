...
public interface GenreAPI {
    ...
    @ApiResponses(value = {
            ...
            @ApiResponse(responseCode = "500", description = "An internal seerver error was thrown")
    })
    ...
    ResponseEntity<?> updateById(@PathVariable(name = "") String id, @RequestBody UpdateGenreRequest update);
