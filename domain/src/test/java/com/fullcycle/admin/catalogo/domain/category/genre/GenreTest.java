...
public class GenreTest {
    ...
    @Test
    public void givenInvalidEmptyName_whenCallNewGenreAndAvalidate_shouldReceiveAError() {
    ...
    @Test
    public void givenInvalidNullName_whenCallNewGenreAndAvalidate_shouldReceiveAError() {
    ...
    @Test
    public void givenInvalidNameWithLengthGreaterThan255_whenCallNewGenreAndAvalidate_shouldReceiveAError() {
    ...
    @Test
    public void givenAValidInactiveGenre_whenCallUpdateWithActivate_shouldReceiveUpdate() {
        final var expectedName = "Ação";
        final var expectedIsActive = true;
    ...
    @Test
    public void givenAValidActiveGenre_whenCallUpdateWithInactivate_shouldReceiveUpdate() {
        final var expectedName = "Ação";
        final var expectedIsActive = false;
        final var expectedCategories = List.of(CategoryID.from("123"));
    ...
    @Test
    public void givenAValidGenre_whenCallUpdateWitheEmptyName_shouldReceiveNotificationException() {
        final var expectedName = " ";
        final var expectedIsActive = true;
        final var expectedCategories = List.of(CategoryID.from("123"));
        final var expectedErrorCount = 1;
    ...
    @Test
    public void givenAValidGenre_whenCallUpdateWitheNullName_shouldReceiveNotificationException() {
        final String expectedName = null;
        final var expectedIsActive = true;
        final var expectedCategories = List.of(CategoryID.from("123"));
        final var expectedErrorCount = 1;
    ...
    @Test
    public void givenAValidGenre_whenCallUpdateWitheNullCategories_shouldReceiveOk() {
